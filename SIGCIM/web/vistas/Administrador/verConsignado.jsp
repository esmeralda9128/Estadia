<%-- 
    Document   : verConsignado
    Created on : 12/06/2019, 01:30:00 PM
...
<html>
    ...
    <head>
        ...
        <title>Ver Consignado - Administrador</title>
    </head>
    <body>
                            ...
                            <div class="basic-tb-hd">
                                ...
                                <div class="row">                                 
                                    <div class="col-lg-4 col-md-5 col-sm-4 col-xs-12">
                                        <div class="txLg">
                                            Razón Social <s:property value="unConsignado.cliente.razonSocial"/>                                           
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-2 col-sm-3 col-xs-12">                                        
                                        <label>No. Consignado</label> <s:property value="unConsignado.numConsignado"/>
                                    </div>                                   
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">                                        
                                        <label>Tienda</label> <s:property value="unConsignado.tienda"/>
                                    </div>                                   
                                </div>
                                <div class="txLg">
                                    Dirección
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <s:property value="unConsignado.calle"/>
                                        <s:property value="unConsignado.colonia"/>                                      
                                        <s:property value="unConsignado.municipio"/>
                                        C.P. <s:property value="unConsignado.codigoPostal"/>
                                        <s:property value="unConsignado.estado"/>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                        <label> Teléfono</label> <s:property value="unConsignado.telefono"/>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                        <label>  Email </label> <s:property value="unConsignado.email"/>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-1 col-sm-1 col-xs-12">
                                        ...
                                        <br/>
                                        <s:property value="unConsignado.informacionAdicional"/>
                                    </div>
                                </div>
                            </div>
                        </div>
