<%-- 
    Document   : login
    Created on : 17/05/2019, 11:29:51 AM
    Author     : horo_
--%>
                            ...
                            <div class="form-example-wrap">
                                ...
                                <div class="form-example-int">
                                    <div class="form-group">
                                        <label>Usuario</label>
                                        <div class="nk-int-st">
                                            <input type="text" required name="login[username]" autocapitalize="off" autocorrect="off" class="form-control input-sm" placeholder="Ingresa tu usuario">
                                        </div>
                                    </div>
                                </div>
